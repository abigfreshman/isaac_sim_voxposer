...
class PutRubbishInBin(BaseTask):
    ...
    def __init__(self,
        ...
        bin_usd_path = "/home/ps/isaacsim42/Voxposer_isaac/scene_obj_usd/bin_no_reference.usd"
        ...
        rep.modify.semantics([("class3", "rubbish")], ["/World/rubbish_cube"])
        ...
        print("#"*100)
        print(f"{bcolors.OKBLUE}start to create camreas")
        # 创建相机之前先创建路径
        create_prim("/World/front")
        create_prim("/World/left_shoulder")
        create_prim("/World/rigth_shoulder")
        create_prim("/World/overhead")
